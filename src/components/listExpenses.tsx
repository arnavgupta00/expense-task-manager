...
export default function ListExpenses(props: { session?: any }) {
  ...
  return (
    <div
      className="w-full rounded-3xl bg-gray-50 p-4"
      style={{
        minHeight: "400px",
        height: "700px",
        borderRadius: "50px",
    ...
    >
      {loading ? (
        <div className="w-full h-full p-0 rounded-3xl">
          {" "}
          <Skeleton
            variant="rectangular"
            animation="wave"
        ...
        <div className=" p-8 pb-20 flex flex-col items-start justify-start gap-4">
            ...
            <div className="w-full h-full flex flex-col items-center justify-center">
              <div
                ...
                style={{
                  alignSelf: "start",
                  marginLeft: `${
                    (getTotalExpenses(listExpenses) / budget) * 100
                  }%`,
                }}
              >
              ...
              >
                ...
                <input
                  type="number"
                  className="w-24 border-gray-300 border-2"
                  value={budget}
